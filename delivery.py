...
class Delivery:
    ...
    def record(self, num_delivered: int, total_damage: float, time_completed: dt.datetime = None):
        ...
        data = {
            ...
            'completion-rate': num_delivered / self.num_of_parcels,
            'damage-rate': total_damage / self.num_of_parcels,
            'time-to-complete': (time_completed - self.time_activated).seconds}
        ...
        print(f"{num_delivered} {self.name_of_parcels}")
        print(f"Completion Rate: {num_delivered / self.num_of_parcels:.2f}")
        print(f"Damage Rate: {total_damage / self.num_of_parcels:.2f}\n")